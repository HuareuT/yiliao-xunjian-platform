...
export function useDiagnosisFormSchema(categories: DiagnosisCategory[]): VbenFormSchema[] {
  return [
    {
      component: "Select",
      componentProps: {
...
export function useColumns(
  onStatusChange?: (newStatus: number, row: DiagnosisRecord) => PromiseLike<boolean | undefined>,
